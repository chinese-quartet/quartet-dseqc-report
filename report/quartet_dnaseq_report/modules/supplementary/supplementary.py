    ...
    html = '''
      ...
      <div class='methods'>
        <div class='small-12 columns'>
          ...
          <p>
            <b>3.</b>	Total score = (1+0.5<sup>2</sup>) x SNV_score x INDEL_score / (0.5<sup>2</sup> x SNV_score + INDEL_score). SNV_score and INDEL_score are obtained by calculating the mean values of Precision, Recall, and MCR, respectively.
          </p>
        </div>
      </div>
      ...
      <div class='reference'>
        ...
        <span class='reference'><b>1.</b> <a name='ref-1' href='https://support.sentieon.com/versions/201808.01/manual/'>https://support.sentieon.com/versions/201808.01/manual/</a></span><br>
        <span class='reference'><b>2.</b> <a name='ref-2' href='https://www.bioinformatics.babraham.ac.uk/projects/fastqc/'>https://www.bioinformatics.babraham.ac.uk/projects/fastqc/</a></span><br>
        <span class='reference'><b>3.</b> <a name='ref-3' href='https://www.bioinformatics.babraham.ac.uk/projects/fastq_screen/'>https://www.bioinformatics.babraham.ac.uk/projects/fastq_screen/</a></span><br>
        <span class='reference'><b>4.</b> <a name='ref-4' href='http://qualimap.bioinfo.cipf.es/'>http://qualimap.bioinfo.cipf.es/</a></span>
        </div>
      </div>
      ...
      <div class='software'>
        ...
        <dl class='dl-horizontal'>
          <dt style='text-align:left; width: 300px'>Sentieon Genomics (FASTQ to VCF)</dt><dd>v2019.11.28</dd>
          <dt style='text-align:left; width: 300px'>FastQC</dt><dd>v0.11.8</dd>
          <dt style='text-align:left; width: 300px'>FastQ Screen</dt><dd>v0.12.0</dd>
          <dt style='text-align:left; width: 300px'>Qualimap</dt><dd>v2.0.0</dd>
          <dt style='text-align:left; width: 300px'>hap.py</dt><dd>v0.3.7</dd>
          <dt style='text-align:left; width: 300px'>VBT (mendelian analysis)</dt><dd>v1.1</dd>
        </dl>
      </div>
